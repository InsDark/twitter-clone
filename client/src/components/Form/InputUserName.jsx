...
const InputUserName = () => {
    ...
    return (
        <div className='flex flex-col'>
            <input placeholder='UserName' name='user-name' onChange={ (e) => checkUserName(e)} type="text" className={`w-full outline-none border-2 rounded pl-3 p-3 border-gray-500 bg-black ${validUserName == null ? '' : (!validUserName ? "border-red-600" : ' border-blue-600')}`} />
